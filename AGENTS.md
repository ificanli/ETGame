...
### et-plan - 版本/周计划管理（最高优先级）

**使用场景**：
- 创建或更新版本计划、周计划
- 添加新任务到计划
- 推进任务状态（未提需求→设计中→开发中→未回归→回归通过→未人工验收→已验收）
- 查看当前计划进度
- **任何新任务必须先在计划中登记，不在计划里的活不干**

### et-design - 文档驱动开发（开发入口）

**使用场景**：
- 用户要求实现新功能
- 用户要求修改现有功能
- 用户要求修复 bug 或重构代码
- **任何涉及代码编写的开发任务，必须经过此 skill 的门禁检查**
- 强制流程：检查计划 → 检查设计文档 → 创建开发文档 → 开发 → 双更新

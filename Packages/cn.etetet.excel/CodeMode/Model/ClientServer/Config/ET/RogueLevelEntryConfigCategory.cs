...
namespace ET
{
    ...
    public partial class RogueLevelEntryConfigCategory : Singleton<RogueLevelEntryConfigCategory>, IConfig
    {
        ...
        public Dictionary<int, ET.RogueLevelEntryConfig> GetAll() => _dataMap;
        public Dictionary<int, ET.RogueLevelEntryConfig> DataMap => _dataMap;
        public List<ET.RogueLevelEntryConfig> DataList => _dataList;

        public ET.RogueLevelEntryConfig GetOrDefault(int key) => _dataMap.GetValueOrDefault(key);

        public ET.RogueLevelEntryConfig Get(int key)
        {

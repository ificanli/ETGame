namespace ET.Server
{
    ...
    public static partial class RogueProgressComponentSystem
    {
        ...
        private static void Awake(this RogueProgressComponent self)
        {
            ...
            self.AppliedBuffIds.Clear();
            self.SelectedOptionIds.Clear();
            self.ClaimedPointRewardIds.Clear();
            self.AppliedLevelNumericTotals.Clear();
            self.CommonShowTagCounts.Clear();
            self.AppliedShowTagBuffIds.Clear();

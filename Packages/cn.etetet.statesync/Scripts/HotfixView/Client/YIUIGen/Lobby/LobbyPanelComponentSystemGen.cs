...
namespace ET.Client
{
    ...
    public static partial class LobbyPanelComponentSystem
    {
        ...
        private static void UIBind(this LobbyPanelComponent self)
        {
            ...
            self.u_ComSecureGridRoot = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComSecureGridRoot");
            self.u_ComSecureItemsLayer = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComSecureItemsLayer");
            self.u_ComSecureItemTemplate = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComSecureItemTemplate");
            self.u_ComWarehouseLoopScroll = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComWarehouseLoopScroll");
            self.u_ComCurrentBagRoot = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComCurrentBagRoot");
            self.u_ComCurrentBagBoardRoot = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComCurrentBagBoardRoot");
            ...
            self.u_DataWarehouseEmptyText = self.UIBase.DataTable.FindDataValue<YIUIFramework.UIDataValueString>("u_DataWarehouseEmptyText");
            self.u_DataTotalWealthText = self.UIBase.DataTable.FindDataValue<YIUIFramework.UIDataValueString>("u_DataTotalWealthText");
            ...
            self.u_EventClickBag = self.UIBase.EventTable.FindEvent<UITaskEventP0>("u_EventClickBag");

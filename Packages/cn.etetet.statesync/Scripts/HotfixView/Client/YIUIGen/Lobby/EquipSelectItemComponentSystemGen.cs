...
namespace ET.Client
{
    ...
    public static partial class EquipSelectItemComponentSystem
    {
        ...
        private static void UIBind(this EquipSelectItemComponent self)
        {
            ...
            self.u_ComIcon = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComIcon");
            self.u_ComBgRectTransform = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComBgRectTransform");

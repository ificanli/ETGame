...
namespace ET.Client
{
    ...
    public static partial class EquipSlotItemComponentSystem
    {
        ...
        private static void UIBind(this EquipSlotItemComponent self)
        {
            ...
            self.u_ComGunRectTransform = self.UIBase.ComponentTable.FindComponent<UnityEngine.RectTransform>("u_ComGunRectTransform");
            ...
            self.u_EventSlotClick = self.UIBase.EventTable.FindEvent<UITaskEventP0>("u_EventSlotClick");
            self.u_EventSlotClickHandle = self.u_EventSlotClick.Add(self,EquipSlotItemComponent.OnEventSlotClickInvoke);

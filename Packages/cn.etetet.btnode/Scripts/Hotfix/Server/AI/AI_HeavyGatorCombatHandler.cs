...
namespace ET.Server
{
    public class AI_HeavyGatorCombatHandler: ABTCoroutineHandler<AI_HeavyGatorCombat>
    {
        protected override async ETTask RunAsync(AI_HeavyGatorCombat node, BTEnv env)
        {
            ...
            int thinkIntervalMs = math.max(100, node.ThinkIntervalMs);

namespace ET.Server
{
    ...
    public class G2Archive_SavePlayerArchiveRequestHandler : MessageHandler<Scene, G2Archive_SavePlayerArchiveRequest, Archive2G_SavePlayerArchiveResponse>
    {
        protected override async ETTask Run(Scene root, G2Archive_SavePlayerArchiveRequest request, Archive2G_SavePlayerArchiveResponse response)
        {

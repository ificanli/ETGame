...
> **[已废弃 / 历史方案]**
> 本文档对应旧版 `BuildPanel / 工坊 / 合同` UI 结构，只作为样机阶段记录保留。
> 当前家园正式版 UI 基线请改读 [../../../Book/06-家园系统/家园UI设计文档.md](../../../Book/06-家园系统/家园UI设计文档.md) 与 [../../../Book/06-家园系统/家园系统需求文档.md](../../../Book/06-家园系统/家园系统需求文档.md)。

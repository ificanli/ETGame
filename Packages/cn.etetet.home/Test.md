...
> **[已废弃 / 待重写]**
> 本文档基于旧版 `补给站 / 工坊 / 情报站 / 合同` 体系编写，已不代表当前家园正式版测试范围。
> 当前应以 [../../Book/06-家园系统/家园系统需求文档.md](../../Book/06-家园系统/家园系统需求文档.md) 和 [../../Book/06-家园系统/家园UI设计文档.md](../../Book/06-家园系统/家园UI设计文档.md) 为准，后续需按 `主城 / 大红收藏馆 / 物品回收间 / 农场 / 仓库` 体系重写测试设计。
